...
│       ├── components/       # layout (Navbar, Footer, MainLayout), guards, common UI
...
Never leave code changes undocumented. Documentation in `docs/` must strictly remain the single source of truth for the codebase.
...
| **Navbar Component** | `frontend/src/components/layout/Navbar.jsx` | Navigation pills, real-time alert badge |
